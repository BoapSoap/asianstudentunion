...
class CanvAscii {
  ...
  updateRotation() {
    const x = map(this.mouse.y, 0, this.height, 0.28, -0.28);
    const y = map(this.mouse.x, 0, this.width, -0.28, 0.28);

    this.mesh.rotation.x += (x - this.mesh.rotation.x) * 0.035;
    this.mesh.rotation.y += (y - this.mesh.rotation.y) * 0.035;
  }
