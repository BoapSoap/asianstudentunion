...
export default function FileDropField({ label, name, accept = "image/*", helperText, initialPreview, onSelect }: Props) {
  ...
  return (
    <Stack spacing={1}>
      <Typography variant="subtitle2" sx={{ color: "rgba(255,255,255,0.86)" }}>
        {label}
      </Typography>
      ...
      <Paper
        ...
        sx={{
          position: "relative",
          borderStyle: "dashed",
          borderColor: active ? "rgba(253,230,138,0.9)" : "rgba(255,255,255,0.35)",
          bgcolor: active ? "rgba(245,158,11,0.12)" : "rgba(0,0,0,0.25)",
          borderRadius: 2,
          p: 1.75,
          cursor: "pointer",
